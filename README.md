...
Built a Spam Email Classifier using supervised learning to detect spam vs legitimate emails. Applied preprocessing (tokenization, stopword removal) and TF-IDF. Trained Naive Bayes & Logistic Regression. Evaluated using accuracy, precision, recall, and confusion matrix; achieved reliable results.
